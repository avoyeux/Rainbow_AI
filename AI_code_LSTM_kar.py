...
if __name__ == '__main__':
    ...
    ModelRunner(ModelClassList=[VaryingLSTMKernelSizes_2Inputs], DataClass=KarineDataGenOrdered_2Inputs, kernel_size_LSTM=[(7, 7), (7, 7), (7, 7)], 
                kernel_size_conv=[(7, 7), (7, 7), (7, 7)], epochs=1000, first_filters=128, batch_size=1)
